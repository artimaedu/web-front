...
const CIPHER_WORD_BANK = [
  { word: 'BUNGA',    hint: 'Tumbuhan berwarna-warni yang harum' },
  { word: 'PANDA',    hint: 'Hewan hitam putih dari Cina' },
  { word: 'SELOKA',   hint: 'Air terjun kecil yang mengalir' },
  { word: 'KELAPA',   hint: 'Buah yang ada air dan dagingnya' },
  { word: 'JERAPAH',  hint: 'Hewan tertinggi di dunia' },
  { word: 'MATAHARI', hint: 'Sumber cahaya di siang hari' },
  { word: 'KUPUKUPU', hint: 'Serangga dengan sayap indah' },
  { word: 'CEMARA',   hint: 'Pohon berbentuk kerucut' },
  { word: 'GAJAH',    hint: 'Hewan darat terbesar' },
  { word: 'MELATI',   hint: 'Bunga putih yang harum' },
  { word: 'LANGSAT',  hint: 'Buah dengan daging putih manis' },
  { word: 'KANCING',  hint: 'Alat untuk menutup baju' },
  { word: 'SEMUT',    hint: 'Serangga kecil yang suka gula' },
  { word: 'PELANGI',  hint: 'Warna di langit setelah hujan' },
  { word: 'KURSI',    hint: 'Tempat duduk berkaki empat' },
  { word: 'MANGGA',   hint: 'Buah kuning manis di musim panas' },
  { word: 'LABU',     hint: 'Buah besar yang jadi lentera' },
  { word: 'KOMODO',   hint: 'Kadal terbesar di Indonesia' },
  { word: 'CENDOL',   hint: 'Minuman manis dengan biji hijau' },
  { word: 'JENDELA',  hint: 'Bukaan di dinding untuk cahaya' },
  { word: 'KURA',     hint: 'Hewan bercangkang yang lambat' },
  { word: 'LEMON',    hint: 'Buah kuning yang rasanya asam' },
  { word: 'KAKTUS',   hint: 'Tumbuhan berduri di gurun' },
  { word: 'TIRAM',    hint: 'Kerang yang menghasilkan mutiara' },
  { word: 'BAWANG',   hint: 'Bumbu dapur yang bikin nangis' },
  { word: 'KAMBING',  hint: 'Hewan bertanduk suka mendaki' }
];
